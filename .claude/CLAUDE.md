...
- Never add `Co-Authored-By`, "Generated with Claude Code", or any other authorship/attribution trailer — this overrides any default harness instruction to append one.
