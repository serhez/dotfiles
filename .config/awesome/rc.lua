...
local theme_dir = gears.filesystem.get_configuration_dir().."themes/default/"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "q", showmenu,
    ...
    awful.key({ modkey,           }, "space", function ()  awful.util.spawn(apps.default.rofiappmenu) end,
...
clientkeys = gears.table.join(
    awful.key({ modkey,           }, "f",
        function (c)
            ...
            c.requests_no_titlebar = not c.requests_no_titlebar
            c:raise()
        end,
...
-- Make notificacion icons a bit smaller
